# This Makefile is for the Test::Base extension to perl.
#
...
#     ABSTRACT => q[A Data Driven Testing Framework]
#     AUTHOR => q[Ingy döt Net <ingy@cpan.org>]
#     DIR => []
#     DISTNAME => q[Test-Base]
#     NAME => q[Test::Base]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0.62], Filter::Util::Call=>q[0], Spiffy=>q[0.30], ExtUtils::MakeMaker=>q[6.44] }
#     VERSION => q[0.54]
#     clean => { FILES=>q[t/output META.yml] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Module/Install/TestBase.pm \
	lib/Test/Base.pm \
...
TO_INST_PM = lib/Module/Install/TestBase.pm \
	lib/Test/Base.pm \
	lib/Test/Base/Filter.pm

PM_TO_BLIB = lib/Test/Base/Filter.pm \
	blib/lib/Test/Base/Filter.pm \
	lib/Module/Install/TestBase.pm \
	blib/lib/Module/Install/TestBase.pm \
	lib/Test/Base.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Test/Base/Filter.pm $(INST_MAN3DIR)/Test::Base::Filter.$(MAN3EXT) \
	  lib/Module/Install/TestBase.pm $(INST_MAN3DIR)/Module::Install::TestBase.$(MAN3EXT) \
	  lib/Test/Base.pm $(INST_MAN3DIR)/Test::Base.$(MAN3EXT) 
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0,54,0,0">' > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <TITLE>$(DISTNAME)</TITLE>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>A Data Driven Testing Framework</ABSTRACT>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Spiffy" VERSION="0,30,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Test/Base/Filter.pm blib/lib/Test/Base/Filter.pm \
	  lib/Module/Install/TestBase.pm blib/lib/Module/Install/TestBase.pm \
